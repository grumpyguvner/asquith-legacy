...
$_['text_advanced_coupon'] = 'Success: Your Advanced Coupon discount has been applied!';
...
$_['text_items']             = 'Your bag (%s item(s) - %s)';
$_['text_next']              = 'What would you like to do next?';
//$_['text_next_choice']       = 'Choose if you have a discount code or reward points you want to use or would like to estimate your delivery cost.';
$_['text_next_choice']       = 'Choose if you have a promotion code:';
$_['text_use_coupon']        = 'Use Coupon Code';
$_['text_use_advanced_coupon'] = 'Use Promotion Code';
...
$_['entry_advanced_coupon'] = 'Enter Your Promotion Coupon here:';
...
$_['error_advanced_coupon']  = 'Warning: Advanced Coupon is either invalid, expired or reached its usage limit!';
$_['error_coupon_login']     = 'Warning: You must be logged in to use this coupon code! <a href="/account/login">log in now</a>';
