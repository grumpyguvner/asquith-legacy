...
// Text
$_['text_title']        = 'Credit Card / Debit Card (TNS)';
$_['text_response']     = 'Response from Transaction Network Services:';
...
$_['text_hash_mismatch']  = 'Callback Hash does not match. Order requires investigation.';