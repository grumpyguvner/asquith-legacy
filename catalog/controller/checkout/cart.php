...
class ControllerCheckoutCart extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->post['advanced_coupon']) && $this->validateAdvancedCoupon()) { 
            ...
            $this->session->data['success'] = $this->language->get('text_advanced_coupon');
            $this->redirect($this->url->link('checkout/cart'));
        }
        ...
        if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
            ...
            $total_data = array();
            //2012-10-25 This line was commented out by MH as when using Vouchers
            // the voucher amount was always £0.00!
//            $total = 0;
