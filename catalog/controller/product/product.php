...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			if ($this->config->get('config_captcha_status'))
			{
			...
			$this->data['shopping'] = $this->url->link('common/home');
			...
			if (isset($manufacturer_info['image']) && $manufacturer_info['image']) {
                            //TODO: Add Brand Image size to config
//				$this->data['manufacturer_logo'] = $this->model_tool_image->resize($manufacturer_info['image'], $this->config->get('config_image_manufacturer_width'), $this->config->get('config_image_manufacturer_height'));
				$this->data['manufacturer_logo'] = $this->model_tool_image->resize($manufacturer_info['image'], 272, 64);
			} else {
				$this->data['manufacturer_logo'] = '';
			}
	...
	public function write() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			/* Added 12/8/12 TF : Turn Captcha on and off */
			if ($this->config->get('config_captcha_status'))
			{
