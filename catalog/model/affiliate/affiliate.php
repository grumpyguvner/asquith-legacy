...
class ModelAffiliateAffiliate extends Model {
	public function addAffiliate($data, $sendEmail = true) {
            ...
            if ($sendEmail) {
                $subject = $this->config->get('config_email_affiliate_subject');
                $message = $this->config->get('config_email_affiliate_body');
