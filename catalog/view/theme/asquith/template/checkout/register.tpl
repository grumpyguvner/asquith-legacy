...
<div class="right">
  ...
  <select name="country_id" class="large-field" onchange="$('#payment-address select[name=\'zone_id\']').load('checkout/register/zone&country_id=' + this.value);">
...
<div style="clear: both; padding-top: 15px; border-top: 1px solid #EEEEEE;">
  ...
  <br />
  <?php } ?>
  <input type="checkbox" name="newsletter" value="1" id="newsletter" checked="checked" style="display: none;" />
  <label for="newsletter" style="display: none;"><?php echo $entry_newsletter; ?></label>
  <br />
</div>
<?php if ($text_agree) { ?>
<div class="buttons">
