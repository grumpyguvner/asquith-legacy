        ...
        <div id="tab-option">
          ...
          ?>
            <tr>
              ...
              <td><?php if ($config_captcha_status) { ?>
                <input type="radio" name="config_captcha_status" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_captcha_status" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_captcha_status" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_captcha_status" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
          <?php
