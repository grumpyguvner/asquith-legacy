        ...
        <div class="content">
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                    ...
                    <div id="language<?php echo $language['language_id']; ?>">
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][meta_title]" value="<?php echo isset($product_description[$language['language_id']]['meta_title']) ? $product_description[$language['language_id']]['meta_title'] : ''; ?>" size="100" /></td>
                            </tr>
                            <tr>
                ...
                <div id="tab-data">
                    <table class="form">
                        <tr>
                            <td><?php echo $entry_giftwrap; ?></td>
                            <td><?php
                                if($giftwrap == 1){
                                ?>
                                <input type="checkbox" value="1" name="giftwrap" checked="checked" />
                                <?php
                                } else {
                                ?>
                                <input type="checkbox" value="1" name="giftwrap" />
                                <?php
                                }
                                ?></td>
                        </tr>
                        ...
                        <tbody id="attribute-row<?php echo $attribute_row; ?>">
                            <tr>
                                ...
                                <td class="left"><?php foreach ($languages as $language) { ?>
                                    <?php if ($product_attribute['group_id'] == 4) { ?>
                                        <textarea id="product_attribute_<?php echo $attribute_row; ?>_product_attribute_description_<?php echo $language['language_id']; ?>" name="product_attribute[<?php echo $attribute_row; ?>][product_attribute_description][<?php echo $language['language_id']; ?>][text]" cols="40" rows="5"><?php echo isset($product_attribute['product_attribute_description'][$language['language_id']]) ? $product_attribute['product_attribute_description'][$language['language_id']]['text'] : ''; ?></textarea>
                                        <script type="text/javascript"><!--
                                                CKEDITOR.replace('product_attribute_<?php echo $attribute_row; ?>_product_attribute_description_<?php echo $language['language_id']; ?>', {
                              ...
                              <tr>
                                <td class="left">
                                    <?php if (!empty($product_image['image']) && !empty($product_image['video'])) { ?>
                                        <div class="image" style="text-align: center; width: 152px;">
