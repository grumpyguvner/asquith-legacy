	...
	private $error = array(); 
  	...
  	public function insert() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$new_id = $this->model_catalog_product->addProduct($this->request->post);
  	...
  	private function getForm() {
        ...
        $this->data['entry_giftwrap'] = $this->language->get('entry_giftwrap');
...
if (isset($this->request->post['giftwrap'])) {
 $this->data['giftwrap'] = $this->request->post['giftwrap'];
 } else if (isset($product_info)) {
 $this->data['giftwrap'] = $product_info['giftwrap'];
 } else {
 $this->data['giftwrap'] = '';
 }
