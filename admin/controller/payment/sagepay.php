...
class ControllerPaymentSagepay extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['sagepay_email'])) {
			$this->data['sagepay_email'] = $this->request->post['sagepay_email'];
		} else {
			$this->data['sagepay_email'] = $this->config->get('sagepay_email');
		}
	...
	private function validate() {
		...
		if (!$this->request->post['sagepay_email']) {
